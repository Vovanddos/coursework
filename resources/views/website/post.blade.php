...
{{--                </div>--}}
                ...
                <div class="sidebar-box">
                    <div class="bio text-center">
                        ...
                        <div class="bio-body">
                            ...
                            <p><a href="{{route('website.about')}}" class="btn btn-primary btn-sm rounded px-4 py-2">Мой профиль</a></p>
                            <p class="social">
                ...
                <div class="sidebar-box">
                    ...
                    <ul class="categories">
                        ...
                        <li><a href="{{ route('website.category', ['slug' => $category->slug]) }}">{{ $category->name }} <span></span> </a></li>
                        @endforeach
                    </ul>
                </div>
                <!-- END sidebar-box -->
