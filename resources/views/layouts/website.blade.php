      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="{{route('website')}}" class="text-black h2 mb-0">Laravel-Blog</a>
          </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <ul class="list-unstyled float-left mr-5">
              <li><a href="{{ route('website') }}">Главная</a></li>
              <li><a href="{{ route('website.about') }}">Обо мне</a></li>
              <li><a href="{{ route('website.contact') }}">Контакты</a></li>
            </ul>
          ...
          <div class="col-md-4">
            <div>
              ...
              <p>
                  @if($setting->facebook) <a href="#">{{ $setting->facebook }}</a><br> @endif
                  @if($setting->twitter)<a href="#">{{ $setting->twitter }}</a><br> @endif
                  @if($setting->instagram)<a href="#">{{ $setting->instagram }}</a><br>  @endif
                  @if($setting->reddit)<a href="#">{{ $setting->reddit }}</a><br> @endif
                  @if($setting->email)<a href="#">{{ $setting->email }}</a><br> @endif
                      @if($setting->phone)<a href="#">{{ $setting->phone }}</a><br> @endif
