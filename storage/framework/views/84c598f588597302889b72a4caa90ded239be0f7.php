            ...
            <div class="col-lg-4 mb-4">
                <div class="entry2">
                    ...
                    <div class="excerpt">
                        ...
                        <p> <?php echo Str::limit($post->description, 300); ?> </p>
                        <p><a href="<?php echo e(route('website.post', ['slug' => $post->slug])); ?>"></a></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.website', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\laravel-blog-coursework\resources\views/website/home.blade.php ENDPATH**/ ?>